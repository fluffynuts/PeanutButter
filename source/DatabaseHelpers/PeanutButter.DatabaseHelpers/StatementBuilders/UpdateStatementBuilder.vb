...
Namespace StatementBuilders
  ...
  Public Class UpdateStatementBuilder
    ...
    Private ReadOnly _fields As List(Of FieldWithValue)
    ...
    End Function
    Public Sub New()
      _fields = New List(Of FieldWithValue)
    End Sub
    ...
    Public Function WithFieldCopy(srcField As String, dstField As String) As IUpdateStatementBuilder Implements IUpdateStatementBuilder.WithFieldCopy
      _fields.Add(New FieldWithValue(dstField, _openObjectQuote + srcField + _closeObjectQuote, False))
      Return Me
    End Function
    Public Function WithField(column As String, value As String, Optional quote As Boolean = True) As IUpdateStatementBuilder Implements IUpdateStatementBuilder.WithField
      _fields.Add(New FieldWithValue(column, value, quote))
      Return Me
    End Function
    ...
    Private Sub CheckBuildParameters()
      If String.IsNullOrEmpty(_table) Then
        Throw New ArgumentException(MakeMessage("Table not set"))
      End If
      If _fields.Count = 0 Then
        Throw New ArgumentException(MakeMessage("No fields specified"))
      End If
      If _condition Is Nothing And Not _forAllRows Then
        Throw New ArgumentException(MakeMessage("No condition specified"))
      End If
    End Sub
    ...
    Public Function WithCondition(fieldName As String, op As Condition.EqualityOperators, fieldValue As Date) As IUpdateStatementBuilder Implements IUpdateStatementBuilder.WithCondition
      Return WithCondition(New Condition(fieldName, op, fieldValue))
    End Function
