...
namespace RandomBuilderPerformanceTest.Fortel
{
    public class JobViewModel : ViewModelBase
    {
        ...
        public new bool CanEdit => Status == Status.Open || Status == Status.FailedQa || Status == Status.FailedReconQuality ||
                                   Status == Status.FailedReconQuantity;
        public ContactViewModel Director => ContactViewModels?.FirstOrDefault(contactViewModel => contactViewModel != null && DesignationGroups.DirectorDesignations.Contains(contactViewModel.Designation));
        public ContactViewModel AreaManager => ContactViewModels?.FirstOrDefault(contactViewModel => contactViewModel != null && DesignationGroups.AreaManagerDesignations.Contains(contactViewModel.Designation));
        public ContactViewModel TeamLeader => ContactViewModels?.FirstOrDefault(contactViewModel => contactViewModel != null && DesignationGroups.TeamLeaderDesignations.Contains(contactViewModel.Designation));
        public ContactViewModel AdminOfficer => ContactViewModels?.FirstOrDefault(contactViewModel => contactViewModel != null && DesignationGroups.AdminOfficerDesignations.Contains(contactViewModel.Designation));
        public ContactViewModel CustomerRepresentative => ContactViewModels?.FirstOrDefault(contactViewModel => contactViewModel != null && (contactViewModel.Designation == Designation.CustomerRepresentative));
