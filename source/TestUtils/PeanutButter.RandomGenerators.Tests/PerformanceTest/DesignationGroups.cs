namespace PeanutButter.RandomGenerators.Tests.PerformanceTest
{
    public static class DesignationGroups
    {
        ...
        public static readonly Designation[] TeamLeaderDesignations =
        {
            ...
            Designation.Specialist, Designation.Technician, Designation.BuildOfficer, Designation.Foreman,
            Designation.HealthAndSafetyOfficer
        };

        public static readonly Designation[] AdminOfficerDesignations =
        {
            Designation.MidAdminOfficer, Designation.JuniorAdminOfficer, Designation.AdminSupervisor,
            Designation.AccountsSupervisor, Designation.AdminManager
        };
