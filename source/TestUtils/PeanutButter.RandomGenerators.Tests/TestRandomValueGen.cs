...
public class TestRandomValueGen
{
    ...
    public class GetRandomArray
    {
        ...
        [Test]
        public void ShouldBeAbleToCreateCastArray()
        {
            // Arrange
            // Act
    ...
    public class GetRandomCollection
    {
        ...
        [Test]
        public void ShouldBeAbleToCreateCastCollection()
        {
            // Arrange
            // Act
            var result = GetRandomCollection<SomePOCO, ISomePOCO>(
    ...
    public class RestrictingValuesForProperty
    {
        ...
        [Restrict(
            nameof(Person.OddNumber),
            Numbers.One,
            Numbers.Three
        )]
        [Restrict(
            nameof(Person.EvenNumber),
            "Two",
            "Four"
        )]
